...
export function ExploreParticles() {
  ...
  return (
    <View style={{ position: "absolute", top: 0, left: -60, right: -60, bottom: 0, alignItems: "center", flexDirection: "row", justifyContent: "space-between", pointerEvents: "none" } as any}>
      <ParticleCanvas />
      <ParticleCanvas flip />
    </View>
  );
